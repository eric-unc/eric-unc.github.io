    ...
    <section class="section">
      <div class="container">
        <div class="content">
          ...
          <ul>
            <li>TEE sandboxing for LLMs; this project is my current focus. Inspired by papers like <a href="https://dl.acm.org/doi/pdf/10.1145/3231594">Ryoan</a>, I am exploring a powerful threat model where neither an application nor a hypervisor is not trusted to not leak sensitive data. We are exploring covert channels between an application and hypervisor and defenses for them, particularly for large language models. I am working on a paper on this topic.</li>
