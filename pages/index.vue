  ...
  <div>
          ...
          <div class="column">
            <div class="box">
              <div class="content">
                ...
                <p>I was born in Charlotte, North Carolina, and raised in Weddington, North Carolina. I am currently an undergraduate student at the University of North Carolina at Chapel Hill, graduating in May 2023. I am a double major in Computer Science (BS) and Mathematics (BS), and I expect to begin working towards an MS in Computer Science starting fall 2023.</p>
    ...
    <section class="section">
      <div class="content">
        ...
        <p>I originally gained an appreciation for computer programming through <a href="https://ftb.fandom.com/wiki/Mods">Minecraft modding</a>. Although I am no longer very active in the scene, I have created, taken over, or contributed towards several well-used Minecraft mods. <a href="https://www.curseforge.com/minecraft/mc-mods/nuclear-control-2">Nuclear Control 2</a> (now discontinued) is probably my biggest project, which has more than 5.6 million downloads. Notable other projects include <a href="https://www.curseforge.com/minecraft/mc-mods/afsu-mod">the AFSU Mod</a> (with 205k downloads), <a href="https://www.curseforge.com/minecraft/mc-mods/flaxbeards-steam-power">Flaxbeard's Steam Power</a> (also known as Esteemed Innovation, with 992k downloads), <a href="https://www.curseforge.com/minecraft/mc-mods/world-control">World Control</a> (1.1m downloads), <a href="https://www.curseforge.com/minecraft/mc-mods/long-fall-boots">Long Fall Boots</a> (15.3m downloads), and <a href="https://www.curseforge.com/minecraft/mc-mods/huesodewiki">HuesoDeWiki</a> (with 5.4k downloads). All are written in Java.</p>
        ...
        <ul>
          ...
          <li><span class="has-text-weight-bold">Some</span>:
            <ul>
              <li>Languages: Lisp, Python, Verilog, Bash, Lua, C#, MATLAB, Mathematica, TypeScript.</li>
        ...
        <p>I try to run six days a week. I prefer to run long distances, and ideally would run 40-50 miles a week. I've run six marathons, which I am very proud of. I also lift weights six days a week, with an emphasis on hypertrophy.</p>
